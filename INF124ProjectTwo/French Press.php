      ...
      <div class="ItemPage">
       <div>
        <table class="table-of-variety">
            <tr>
                <!-- sources for pics 
                https://www.sapacoffee.com/products/triple-filter-8-cup-french-press-coffee-brewer
                https://www.homedepot.com/p/Mr-Coffee-Hyland-20-oz-French-Press-Coffee-Maker-with-Scoop-986105354M/311717987
                https://www.amazon.com/Bodum-Chambord-French-Coffee-Chrome/dp/B00008XEWG
                
                -->
                <td> <img src="french-press.jpg" alt=""> <p>Item Code: FP1 $25 dollars</p> </td>
                <td> <img src="fp2.jpg" alt=""> <p>Item Code: FP2 $28 dollars</p> </td>
                <td> <img src="fp3.jpg" alt=""> <p>Item code: FP3 $26 dollars</p></td>
            </tr>
        </table>
       </div>
          ...
          <fieldset>
            ...
            <label>
              Product: <select name="product">
                <option value="French Press: FP1" selected="selected">French Press - FP1</option>
                <option value="French Press: FP2">French Press - FP2</option>
                <option value="French Press: FP3">French Press - FP3</option>
              </select>
            </label>
