          ...
          <fieldset>
            ...
            <label>
              Product: <select name="product">
                <option value="Automatic Drip Coffee: DP1" selected="selected">Automatic Drip Coffee - DP1</option>
                <option value="Automatic Drip Coffee: DP2">Automatic Drip Coffee - DP2</option>
                <option value="Automatic Drip Coffee: DP3">Automatic Drip Coffee - DP3</option>
              </select>
            </label>
