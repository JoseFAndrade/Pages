      ...
      <div class="ItemPage">
        <div>
         <table class="table-of-variety">
             <tr>
                 <!-- sources for pics 
                https://www.amazon.com/AeroPress-Portable-Travel-Coffee-Press/dp/B07YVL8SF3/ref=sr_1_2?dchild=1&keywords=aeropress&qid=1587524660&s=home-garden&sr=1-2
                 
                 -->
                 <td> <img src="aeropress.jpg" alt=""> <p>Item Code: AE1 $31 dollars</p> </td>
             </tr>
         </table>
        </div>
          ...
          <fieldset>
            ...
            <label>
              Product: <select name="product">
                <option value="AE1" selected="selected">Aeropress - AE1</option>
              </select>
            </label>
