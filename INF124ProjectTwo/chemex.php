      ...
      <div class="ItemPage">
        <div>
         <table class="table-of-variety">
             <tr>
                 <!-- sources for pics 
                  https://www.chemexcoffeemaker.com/six-cup-classic-series-coffeemaker.html
                 -->
                 <td> <img src="chemex-bodum.png" alt=""> <p>Item Code: CH1 $43.50 dollars</p> </td>
             </tr>
         </table>
        </div>
          ...
          <fieldset>
            ...
            <label>
              Product: <select name="product">
                <option value="CH1" selected="selected">Chemex - CH1</option>
              </select>
            </label>
