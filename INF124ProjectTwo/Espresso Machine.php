        ...
        <div>
         <table class="table-of-variety">
             <tr>
                 ...
                 -->
                 <td> <img src="espresso-machine.jpg" alt=""> <p>Item Code: EM1 $449 dollars</p> </td>
             </tr>
         </table>
        </div>
          ...
          <fieldset>
            ...
            <label>
              Product: <select name="product">
                <option value="Expresso Machine: EM1" selected="selected">Expresso Machine - EM1</option>
              </select>
            </label>
