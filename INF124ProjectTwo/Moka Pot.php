      ...
      <div class="ItemPage">
        <div>
         <table class="table-of-variety">
             <tr>
                 <!-- sources for pics 
                        https://www.amazon.com/Bialetti-06800-stove-coffee-Aluminum/dp/B000CNY6UK/ref=sr_1_2?dchild=1&keywords=moka+pot&qid=1587525089&s=home-garden&sr=1-2
                 -->
                 <td> <img src="moka-pot-bialetti.png" alt=""> <p>Item Code: MK1 $33 dollars</p> </td>
             </tr>
         </table>
        </div>
          ...
          <fieldset>
            ...
            <label>
              Product: <select name="product">
                <option value="Moka Pot: MK1" selected="selected">Moka Pot - MK1</option>
              </select>
            </label>
